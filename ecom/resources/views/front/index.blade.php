            ...
            <div class="swiper-wrapper">
                ...
                <div class="hero-slide-item swiper-slide">
                    <div class="hero-slide-bg">
                        <img src="{{url('front-assets/images/slider/slider1-1.png')}}" alt="Slider Image" />
                    </div>
                    <div class="container">
                ...
                <div class="hero-slide-item swiper-slide">
                    <div class="hero-slide-bg">
                        <img src="{{url('front-assets/images/slider/slider1-2.png')}}" alt="Slider Image" />
                    </div>
                    <div class="container">
                            ...
                            <div class="row mb-n8">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image" alt="Product" src="{{url('front-assets/images/products/medium-product/1.png')}}"  />
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="col-12 col-sm-6 col-lg-3 product-wrapper mb-8">
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image" src="{{url('front-assets/images/products/medium-product/3.png')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="col-12 col-sm-6 col-lg-3 product-wrapper mb-8">
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image" src="{{url('front-assets/images/products/medium-product/4.png')}}" alt="Product" />
                                            </a>
                                            <div class="action-wrapper">
                                                <a href="#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                                <a href="wishlist.html" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="col-12 col-sm-6 col-lg-3 product-wrapper mb-8">
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image" src="{{url('front-assets/images/products/medium-product/5.png')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                            <span class="sale">-18%</span>
                                            </span>
                                ...
                                <div class="col-12 col-sm-6 col-lg-3 product-wrapper mb-8">
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image" src="{{url('front-assets/images/products/medium-product/6.png')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="col-12 col-sm-6 col-lg-3 product-wrapper mb-8">
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image" src="{{url('front-assets/images/products/medium-product/7.png')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                            <span class="new">New</span>
                                            </span>
                                ...
                                <div class="col-12 col-sm-6 col-lg-3 product-wrapper mb-8">
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image" src="{{url('front-assets/images/products/medium-product/8.png')}}" alt="Product" />
                                            </a>
                                            <div class="action-wrapper">
                                                <a href="#/" class="action quickview" data-bs-toggle="modal" data-bs-target="#quick-view"><i class="ti-plus"></i></a>
                                                <a href="wishlist.html" class="action wishlist" title="Wishlist"><i class="ti-heart"></i></a>
                                ...
                                <div class="col-12 col-sm-6 col-lg-3 product-wrapper mb-8">
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image" src="{{url('front-assets/images/products/medium-product/2.png')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                            <span class="sale">-20%</span>
                                            </span>
                            ...
                            <div class="row mb-n8">
                                ...
                                <div class="col-12 col-sm-6 col-lg-3 product-wrapper mb-8">
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image" src="{{url('front-assets/images/products/medium-product/1.png')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                            <span class="sale">-18%</span>
                                            </span>
            ...
            <div class="row mb-n6">
                ...
                <div class="col-md-6 col-12 mb-6" data-aos="fade-up" data-aos-duration="1000">
                    <a href="shop.html" class="banner">
                        <img class="fit-image" src="{{url('front-assets/images/banner/1.png')}}" alt="Banner Image" />
                    </a>
                </div>
                <!-- Banner End -->
                ...
                <div class="col-md-6 col-12 mb-6" data-aos="fade-up" data-aos-duration="1400">
                    <a href="shop.html" class="banner">
                        <img class="fit-image" src="{{url('front-assets/images/banner/2.png')}}" alt="Banner Image" />
                    </a>
                </div>
                <!-- Banner End -->
                                    ...
                                    <div class="single-deal-product row mb-n6">
                                        ...
                                        <div class="deal-thumb col-md-6 mb-6" data-aos="fade-up" data-aos-duration="1200">
                                            <a href="single-product.html">
                                                <img class="fit-image" src="{{url('front-assets/images/products/large-product/9.png')}}" alt="Product Image">
                                            </a>
                                        </div>
                                        <!-- Deal Thumb End -->
                                        <!-- Deal Content Start -->
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-deal-product row mb-n6">
                                        ...
                                        <div class="deal-thumb col-md-6 mb-6">
                                            <a href="single-product.html">
                                                <img class="fit-image" src="{{url('front-assets/images/products/large-product/10.png')}}" alt="Product Image">
                                            </a>
                                        </div>
                                        <!-- Deal Thumb End -->
                                        <!-- Deal Content Start -->
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="testimonial-thumb text-center">
                                        <img src="{{url('front-assets/images/testimonial/1.png')}}" alt="Testimonial Image">
                                ...
                                <div class="swiper-slide">
                                    <!-- Testimonial Thumb Start -->
                                    <div class="testimonial-thumb text-center">
                                        <img src="{{url('front-assets/images/testimonial/2.png')}}" alt="Testimonial Image">
            ...
            <div class="row row-cols-lg-3 row-cols-sm-2 row-cols-1 mb-n8">
                    ...
                    <div class="single-blog-wrapper">
                        ...
                        <div class="blog-thumb thumb-effect">
                            <a class="image" href="blog-details.html">
                                <img class="fit-image" src="{{url('front-assets/images/blog/medium-size/1.jpg')}}" alt="Blog Image">
                            </a>
                        </div>
                        <!-- Blog Thumb End -->
                ...
                <div class="col mb-8" data-aos="fade-up" data-aos-duration="1300">
                    ...
                    <div class="single-blog-wrapper">
                        ...
                        <div class="blog-thumb thumb-effect">
                            <a class="image" href="blog-details.html">
                                <img class="fit-image" src="{{url('front-assets/images/blog/medium-size/2.jpg')}}" alt="Blog Image">
                            </a>
                        </div>
                        <!-- Blog Thumb End -->
                ...
                <div class="col mb-8" data-aos="fade-up" data-aos-duration="1600">
                    ...
                    <div class="single-blog-wrapper">
                        ...
                        <div class="blog-thumb thumb-effect">
                            <a class="image" href="blog-details.html">
                                <img class="fit-image" src="{{url('front-assets/images/blog/medium-size/3.jpg')}}" alt="Blog Image">
                            </a>
                        </div>
                        <!-- Blog Thumb End -->
