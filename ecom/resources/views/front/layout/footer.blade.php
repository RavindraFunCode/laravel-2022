<!-- Footer Section Start -->
            ...
            <div class="container">
                <div class="row align-items-center mb-n4">
                    ...
                    <div class="col-md-6 text-center text-md-end order-1 order-md-2 mb-4">
                        <div class="payment">
                            <a href="#/">
                                <img class="fit-image" src="{{url('front-assets/images/payment/payment_large.png')}}" alt="Payment">
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100" src="{{url('front-assets/images/products/large-product/1.png')}}" alt="Product">
                                    </a>
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100" src="{{url('front-assets/images/products/large-product/2.png')}}" alt="Product">
                                    </a>
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100" src="{{url('front-assets/images/products/large-product/3.png')}}" alt="Product">
                                    </a>
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100" src="{{url('front-assets/images/products/large-product/4.png')}}" alt="Product">
                                    </a>
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100" src="{{url('front-assets/images/products/large-product/5.png')}}" alt="Product">
                                    </a>
                                </div>
                    ...
                    <div class="col-md-6 col-12 overflow-hidden position-relative">
                        ...
                        <div class="product-summery position-relative">
                            ...
                            <div class="payment-option mt-4 d-flex justify-content-start">
                                ...
                                <a href="#">
                                    <img class="fit-image ms-1" src="{{url('front-assets/images/payment/payment_large.png')}}" alt="Payment Option Image">
                                </a>
                            </div>
                            <!-- Payment Option End -->
    ...
    <script src="{{url('front-assets/js/vendor/popper.min.js')}}"></script>
    ...
    <script src="{{url('front-assets/js/vendor/jquery-migrate-3.3.2.min.js')}}"></script>
    <script src="{{url('front-assets/js/vendor/modernizr-3.11.2.min.js')}}"></script>


    <!-- Plugins JS -->


    <script src="{{url('front-assets/js/plugins/aos.min.js')}}"></script>
    <script src="{{url('front-assets/js/plugins/jquery.ajaxchimp.min.js')}}"></script>
    <script src="{{url('front-assets/js/plugins/jquery-ui.min.js')}}"></script>
    <script src="{{url('front-assets/js/plugins/nice-select.min.js')}}"></script>
    <script src="{{url('front-assets/js/plugins/swiper-bundle.min.js')}}"></script>
    <script src="{{url('front-assets/js/plugins/countdown.min.js')}}"></script>
    <script src="{{url('front-assets/js/plugins/lightgallery-all.min.js')}}"></script>
