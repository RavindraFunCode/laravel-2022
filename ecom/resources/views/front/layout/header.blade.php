...
<head>
    ...
    <link rel="stylesheet" href="{{url('front-assets/css/vendor/fontawesome.min.css')}}" />
    <link rel="stylesheet" href="{{url('front-assets/css/vendor/simple-line-icons.min.css')}}" />
    <link rel="stylesheet" href="{{url('front-assets/css/vendor/themify-icons-min.css')}}" />

    <!-- Plugins CSS (All Plugins Files) -->


    <link rel="stylesheet" href="{{url('front-assets/css/plugins/swiper-bundle.min.css')}}" />
    <link rel="stylesheet" href="{{url('front-assets/css/plugins/animate.min.css')}}" />
    <link rel="stylesheet" href="{{url('front-assets/css/plugins/lightgallery.min.css')}}" />
    <link rel="stylesheet" href="{{url('front-assets/css/plugins/aos.min.css')}}" />
    <link rel="stylesheet" href="{{url('front-assets/css/plugins/nice-select.min.css')}}" />
                    ...
                    <div class="row align-items-center position-relative">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="header-logo">
                                <a href="index.html"><img src="{{url('front-assets/images/logo/logo.png')}}" alt="Site Logo" /></a>
                            </div>
                        </div>
                        <!-- Header Logo End -->
                                        ...
                                        <ul class="mega-menu">
                                            ...
                                            <li class="mega-menu-col">
                                                <div class="megamenu-image">
                                                    <a href="shop.html">
                                                        <img class="fit-image" src="{{url('front-assets/images/header/mega-menu.png')}}" alt="Megamenu Image">
                                                    </a>
                                                </div>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="header-cart-content">
                                        ...
                                        <div class="cart-product-wrapper">
                                            ...
                                            <div class="cart-product-inner mb-4 pb-4 border-bottom">
                                                ...
                                                <div class="single-cart-product">
                                                    <div class="cart-product-thumb">
                                                        <a href="single-product.html"><img src="{{url('front-assets/images/header/header-cart/2.png')}}" alt="Cart Product"></a>
                                                    </div>
                                                    <div class="cart-product-content">
