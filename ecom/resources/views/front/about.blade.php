            ...
            <div class="row mb-n6">
                <div class="col-md-6 pe-lg-9 pe-3 mb-6" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <div class="about-thumb">
                        <img class="fit-image" src="{{asset('front-assets/images/about/1.png')}}" alt="About Image">
                    </div>
                    <!-- About Thumb End -->
                </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="testimonial-thumb text-center">
                                        <img src="{{asset('front-assets/images/testimonial/1.png')}}" alt="Testimonial Image">
                                ...
                                <div class="swiper-slide">
                                    <!-- Testimonial Thumb Start -->
                                    <div class="testimonial-thumb text-center">
                                        <img src="{{asset('front-assets/images/testimonial/2.png')}}" alt="Testimonial Image">
            ...
            <div class="row row-cols-md-3 row-cols-sm-2 row-cols-1 mb-n6">
                ...
                <div class="col mb-6" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <div class="single-team-wrapper">
                        <div class="thumb">
                            <a href="contact.html">
                                <img class="fit-image" src="{{asset('front-assets/images/team/1.jpg')}}" alt="Team Image">
                            </a>
                            <!-- Social Shear Start -->
                ...
                <div class="col mb-6" data-aos="fade-up" data-aos-duration="1500">
                    ...
                    <div class="single-team-wrapper">
                        <div class="thumb">
                            <a href="contact.html">
                                <img class="fit-image" src="{{asset('front-assets/images/team/2.jpg')}}" alt="Team Image">
                            </a>
                            <!-- Social Shear Start -->
                            <div class="social-share">
                                <a title="Twitter" href="#/"><i class="ti-facebook"></i></a>
                ...
                <div class="col mb-6" data-aos="fade-up" data-aos-duration="2000">
                    ...
                    <div class="single-team-wrapper">
                        <div class="thumb">
                            <a href="contact.html">
                                <img class="fit-image" src="{{asset('front-assets/images/team/3.jpg')}}" alt="Team Image">
                            </a>
                            <!-- Social Shear Start -->
                            <div class="social-share">
                                <a title="Twitter" href="#/"><i class="ti-facebook"></i></a>
